 ...
 */
package jptv20task5alesjavassiljeva;
 ...
 * @author pupil
 */
public class Jptv20Task5AlesjaVassiljeva {
    ...
    ZubMas[3] = new int[8];
    ZubMas[4] = new int[9];
    System.out.println("Íåñîðòèðîâàííûé ìàññèâ");
    System.out.println("");
    for (int i = 0; i < ZubMas.length; i++) {
        ...
        System.out.println("");
        System.out.println("Ñîðòèðîâàííûé ìàññèâ");
        System.out.println("");
    for (int i = 0; i < ZubMas.length; i++) {
            for (int j = 0; j < ZubMas[i].length; j++) {
            System.out.printf("%4d",ZubMas[i][j]);
